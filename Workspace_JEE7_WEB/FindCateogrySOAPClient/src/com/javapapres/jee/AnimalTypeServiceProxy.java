...
public class AnimalTypeServiceProxy implements com.javapapres.jee.AnimalTypeService {
  private String _endpoint = null;
  private com.javapapres.jee.AnimalTypeService animalTypeService = null;
  ...
  private void _initAnimalTypeServiceProxy() {
    try {
      animalTypeService = (new com.javapapres.jee.AnimalTypeServiceServiceLocator()).getAnimalTypeService();
  ...
  public com.javapapres.jee.AnimalTypeService getAnimalTypeService() {
    if (animalTypeService == null)
      _initAnimalTypeServiceProxy();
