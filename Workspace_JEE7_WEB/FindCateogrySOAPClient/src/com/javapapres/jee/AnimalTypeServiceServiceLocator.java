...
public class AnimalTypeServiceServiceLocator extends org.apache.axis.client.Service implements com.javapapres.jee.AnimalTypeServiceService {
    ...
    private java.lang.String AnimalTypeService_address = "http://localhost:7070/FindCateogrySOAP/services/AnimalTypeService";
    ...
    public com.javapapres.jee.AnimalTypeService getAnimalTypeService() throws javax.xml.rpc.ServiceException {
    ...
    public com.javapapres.jee.AnimalTypeService getAnimalTypeService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.javapapres.jee.AnimalTypeServiceSoapBindingStub _stub = new com.javapapres.jee.AnimalTypeServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.javapapres.jee.AnimalTypeService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.javapapres.jee.AnimalTypeServiceSoapBindingStub _stub = new com.javapapres.jee.AnimalTypeServiceSoapBindingStub(new java.net.URL(AnimalTypeService_address), this);
                _stub.setPortName(getAnimalTypeServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://jee.javapapres.com", "AnimalTypeServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://jee.javapapres.com", "AnimalTypeService"));
        }
